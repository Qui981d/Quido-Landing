...
export const metadata: Metadata = {
  ...
  keywords: [
    'conciergerie', 'conciergerie locative', 'conciergerie airbnb', 'conciergerie autour de moi',
    'gestion airbnb', 'pays de gex', 'agence airbnb', 'agence de conciergerie',
    ...
    'gestion locative pays de gex', 'gestion locative saint genis pouilly',
    'ménage airbnb pays de gex', 'nettoyage location saisonnière',
    'airbnb autour de moi', 'agence immobilière pays de gex',
    'location courte durée pays de gex', 'conciergerie locative ain',
    'gestion locative près de genève',
  ],
