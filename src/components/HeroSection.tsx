    ...
    <section className="relative pt-32 pb-20 lg:pt-48 lg:pb-32 overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid lg:grid-cols-2 gap-16 lg:gap-12 items-center">
          ...
          <div className="flex flex-col gap-8 animate-hero-text">
          ...
          <div className="relative h-[500px] lg:h-[700px] w-full mt-10 lg:mt-0 flex items-center justify-center">
            ...
            <div 
              className="absolute right-0 top-[5%] w-[70%] h-[80%] z-10 shadow-[0_20px_50px_-12px_rgba(0,0,0,0.15)] overflow-hidden animate-hero-img-main"
            ...
            >
              ...
              <Image fill sizes="(max-width: 1024px) 50vw, 25vw" src="/images/hero-apartment-gex.webp" alt="Appartement en location saisonnière géré par conciergerie Quido au Pays de Gex" className="object-cover" priority />
            </div>

            {/* Image 2: Bedroom */}
            <div 
              className="absolute left-0 bottom-[5%] w-[60%] h-[55%] z-20 shadow-[0_25px_60px_-15px_rgba(0,0,0,0.2)] border-8 border-white overflow-hidden animate-hero-img-bedroom"
            ...
            >
              ...
              <Image fill sizes="(max-width: 1024px) 70vw, 35vw" src="/images/hero-bedroom.webp" alt="Chambre premium aménagée pour location Airbnb à Ferney-Voltaire" className="object-cover" priority />
            </div>

            {/* Image 3: Point de Focus (Cuisine) */}
            <div 
              className="absolute left-[15%] top-0 w-[45%] h-[40%] z-30 shadow-[0_30px_70px_-20px_rgba(0,0,0,0.25)] border-[6px] border-white overflow-hidden animate-hero-img-kitchen"
              style={{ borderRadius: '50% 50% 60% 40% / 40% 60% 40% 60%' }}
            >
              <div className="absolute inset-0 bg-black/5 z-10 transition-colors duration-500 hover:bg-transparent"></div>
              <Image fill sizes="(max-width: 1024px) 40vw, 20vw" src="/images/hero-kitchen.webp" alt="Cuisine équipée pour location saisonnière haut de gamme Pays de Gex" className="object-cover" />
            </div>
          </div>
